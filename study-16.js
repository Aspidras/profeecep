...
PE16.exercise=function(q){
 ...
 return '<div class="studyCard exercise"><div class="studyLabel">✍️ Ejercicio del indicador</div><p><b>'+esc(q.q)+'</b></p>'+(window.PE305?PE305.stimulus(q):'')+'<details><summary>Ver alternativas y solución</summary><div class="guidedOptions">'+q.o.map((o,i)=>'<div>'+String.fromCharCode(65+i)+'. '+esc(o)+'</div>').join("")+'</div><p><b>Respuesta:</b> '+String.fromCharCode(65+q.a)+'. '+esc(q.o[q.a])+'</p><p class="muted">'+esc(q.e)+'</p>'+PE304.alternatives(q)+(window.PE305?PE305.source(q):'')+'</details></div>';
};
