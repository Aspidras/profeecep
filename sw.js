const CACHE='profeecep-2.7';
const ASSETS=['./','./index.html','./styles.css','./app.js','./data.js','./progress-22.js','./content-22.js','./content-23.js','./plan-25.js','./tutor-26.js','./mobile-27.js','./complete-28.js','./manifest.json'];
