// ProfeECEP 3.0.6 — presentation only; progress and question storage stay in their existing modules.
(function () {
  'use strict';
  ...
  function composeHome() {
    ...
    if (!dashboard) {
      ...
      dashboard.innerHTML =
        ...
        '<footer class="pe302-footer"><span>ProfeECEP 3.0.6</span><button class="mini ghost2" data-pe302-action="access">Lectura y accesibilidad</button></footer>';
